...
const LuciaCaminos = () => {
    ...
    useGSAP(() => {
        ...
        gsap.timeline({
            scrollTrigger: {
                trigger: '.lucia-life', start: 'top 80%', end: '10% center', scrub: 2,
            }
        }).to('.second-vd', {
        ...
        gsap.to('.lucia-life .img-box', {
            scrollTrigger: {
                trigger: '.lucia-life', start: 'top center', end: '80% center', scrub: 2,
        ...
        <section className="lucia-life">
            ...
            <div className="flex flex-col gap-5 items-end img-box lg:1/2 ps-10 mt-96">
                <div className="lucia-1">
                    <img src="/images/lucia-1.webp" alt="Lucia boxing"/>
                </div>
                <div className="lucia-3">
                    <img src="/images/lucia-3.webp" alt="Lucia in prison"/>
                </div>
            </div>
            ...
            <div className="lg:w-1/2 lucia-life-content">
                <div className="max-w-xl lg:ps-32 ps-10">
                    ...
                    <p>Life has been coming at her swinging ever since. Fighting for her family landed her in the
                        Leonida
                        Penitentiary. Sheer luck got her out. Lucia’s learned her lesson — only smart moves from here.
                    </p>
                </div>
                <div className="lucia-2">
                    <img src="/images/lucia-2.webp" alt="Lucia in the pool"/>
                </div>
